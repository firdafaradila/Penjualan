  ...
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Putra Bintang</a> 
      </div>
      ...
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li>
            ...
            <?php
             } else if($_SESSION['login_admin']['level'] == "supplier"){
            ?>
          ...
          ?>
            ...
            ?>
              <li>
                <a  href="index.php?page=pembelian&id="><i class="fa fa-database"></i> Data Penjualan</a>
              </li>
              <?php
            }else{
            ?>
              <li>
                <a  href="index.php?page=pembelian&id=<?php echo $_SESSION['login_admin']['id']; ?>"><i class="fa fa-database"></i> Data Pembelian</a>
              </li>
          <?php
          }
         ...
         <li>
            ...
            ?>
              ...
              ?>
              <li>
                <a  href="index.php?page=admin"><i class="fa fa-user"></i> Profile</a>
              </li>
              <?php
            }
            ?>
