		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
						...
						<select class="form-control" onchange="cek_database()"" name="barang" id="barang">
							...
							<?php echo $data['kd_barang']; ?></option>
				...
				<form method="POST">
					...
					<div class="form-group">
						...
						<select class="form-control" name="supplier" id="supplier">
							<?php  
								$sp = $supplier->tampil_supplier_byid($_SESSION['login_admin']['id']);
