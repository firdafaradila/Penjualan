	...
	<div class="col-md-12">
		<div class="box">
			...
			<div class="box-body">	
				<?php 
					if (isset($_POST['save'])) {
						$supplier->simpan_supplier($_POST['nama'],$_POST['alamat'],$_POST['email'],$_POST['password'],$_FILES['gambar']);
				...
				<form method="POST" id="forminput" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Email</label>
						<input type="text" class="form-control" name="email" id="email" placeholder="Masukan Email Supplier">
					</div>
					<div class="form-group">
						<label>Password</label>
						<input type="password" class="form-control" name="password" id="password" placeholder="Masukan Password Supplier">
					</div>
					<div class="form-group">
						<label>Gambar</label>
